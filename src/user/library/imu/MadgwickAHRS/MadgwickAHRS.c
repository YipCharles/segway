...
#define sampleFreq	2000		// sample frequency in Hz
...
{
	angle[0] = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2 * q2 + 1) * 57.3;
	angle[1] = asin(-2 * q1 * q3 + 2 * q0 * q2) * 57.3;
	angle[2] = atan2(2 * q1 * q2 + 2 * q0 * q3, -2 * q2 * q2 - 2 * q3 * q3 + 1) * 57.3;
}
